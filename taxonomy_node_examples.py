BIG_DATA_TAXONOMY = {
	...
	"description": "In diesem Themenbereich auf Serlo findest du drei kurze Artikel, die den Begriff „Big Data“ einfach und anschaulich erklären – die Links dazu findest du unten, am Ende der Einleitung. Viel Spaß!",
...
GAME_THEORY_TAXONOMY = {
	...
	"description": "Spieltheorie ist eine mathematische Disziplin, die das rationale Verhalten von Entscheidungsträgern in interaktiven Situationen analysiert, in denen die Ergebnisse von den Entscheidungen anderer abhängen.",
